...
module.exports = {
    ...
    async execute(message, args, com, client) {
        ...
        if (!playlistName.length) return message.reply(' **you have to specify the name of the playlist you want to play a song from**');
        if (!song_name.length) return message.reply(' **you have to specify the name of the song you want to play**');
