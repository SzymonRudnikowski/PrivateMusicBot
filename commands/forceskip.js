...
module.exports = {
    ...
    async execute(message) {
        ...
        if(message.member.hasPermission(['ADMINISTRATOR']) || member.roles.cache.some(role => role.name === 'DJ') || message.author.id === '259046058737270784' || message.author.id === '391983289122029578'){
            try{
